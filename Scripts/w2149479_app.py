...
#KPI chart to show the total number of displacements across the years
...
plotfig = px.line(trend, x='year',y='new_displacement', labels={'year': 'Year', 'new_displacement': 'Number of People Displaced'}, markers=True, color_discrete_sequence=['darkorange'])
...
topfig = px.bar(top_10, x='country_name', y='new_displacement', labels={'country_name': 'Country', 'new_displacement': 'Number of People Displaced'}, color ='new_displacement', color_continuous_scale='Oranges', text_auto='.2s')
...
hazardfig = px.line(h_trend_f, x='year', y='new_displacement', labels={'year': 'Year', 'new_displacement': 'Number of People Displaced'}, color = 'hazard_type_name',markers=True,color_discrete_sequence=px.colors.qualitative.Vivid)
st.plotly_chart(hazardfig, use_container_width=True)
#Bar chart
#bar chart to show the number of displacements by hazard types
...
barfig = px.bar(no_of_hazard, x='new_displacement', y='hazard_type_name',labels={'new_displacement': 'Number of People Displaced', 'hazard_type_name': 'Hazard Type'} , orientation='h',color = 'hazard_type_name', text_auto='.2s')
